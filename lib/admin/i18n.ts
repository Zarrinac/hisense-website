...
export const adminDictionaries = {
  en: {
    ...
    shell: {
      pathLabel: 'hisense-ir.com/admin',
      nav: {
        dashboard: 'Dashboard',
        products: 'Products',
    ...
    users: {
      eyebrow: 'Access',
      title: 'Users',
      description: 'Create admin accounts and assign their access level.',
      addUser: 'Add user',
      you: '(you)',
      never: 'Never',
      ...
      messages: {
        ...
        usernameChars: 'Username may contain only letters, numbers, dot, underscore, hyphen.',
        usernameTaken: 'That username is already taken.',
        passwordLength: 'Password must be at least 8 characters.',
        lastSuperAdmin: 'Cannot remove the last active super admin.',
  ...
  fa: {
    ...
    users: {
      eyebrow: 'دسترسی',
      title: 'کاربران',
      description: 'حساب های مدیریت را بسازید و سطح دسترسی هر کدام را تعیین کنید.',
      addUser: 'افزودن کاربر',
      you: '(شما)',
      never: 'هرگز',
      confirmDelete: 'کاربر «{username}» حذف شود؟ این عمل قابل بازگشت نیست.',
      resetPasswordTitle: 'تغییر رمز عبور — {username}',
      ...
      messages: {
        ...
        passwordReset: 'رمز عبور به‌روزرسانی شد.',
        forbidden: 'شما اجازه مدیریت کاربران را ندارید.',
        invalid: 'ورودی نامعتبر است.',
        usernameLength: 'نام کاربری باید بین ۳ تا ۵۰ نویسه باشد.',
        usernameChars: 'نام کاربری فقط می تواند شامل حروف، عدد، نقطه، زیرخط و خط تیره باشد.',
        usernameTaken: 'این نام کاربری قبلاً استفاده شده است.',
        passwordLength: 'رمز عبور باید حداقل ۸ نویسه باشد.',
        lastSuperAdmin: 'نمی توان آخرین مدیر ارشد فعال را حذف کرد.',
        notFound: 'کاربر یافت نشد.',
        cannotDeleteSelf: 'نمی توانید حساب خود را حذف کنید.',
