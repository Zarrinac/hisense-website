...
const tgBlocksFa = {
  featureIntro: {
    title: 'سری TG',
    text: 'هوای سالم‌تر، آسایش پایدارتر و مصرف انرژی بهینه‌تر.',
  },
  anionSterilization: {
    title: 'استریلیزاسیون یونی',
    text: 'یون‌های منفی تولید شده توسط دستگاه می‌توانند باکتری‌ها، قارچ‌ها، ویروس‌ها و گرده‌ها را به‌صورت موثر کاهش دهند و کیفیت هوای داخلی را بهبود دهند.',
  },
  ...
  highEnergyEfficiency: {
    ...
    text: 'با فناوری اینورتر سه‌بعدی، مسیر هوای داخلی بهینه و فین‌های پیشرفته، بازدهی انرژی افزایش یافته و مصرف برق تا ۳۰ درصد کاهش می‌یابد.',
  },
...
const tgCommonSpecsFa = [
  ...
  '• مجهز به فیلتر 4 در 1',
  '• صرفه جویی در انرژی و عملکرد فوق العاده',
  '• محدوده ولتاژ کارکرد 150 ~ 264',
  '• محدوده دمای کارکرد تا 50 درجه',
  'فیلتر 4 در 1',
  'فیلتر هپا (حذف 99.7% ذرات 0.3 میکرومتر)',
  'فیلتر یون نقره ای',
  'فیلتر ویتامین C',
  ...
  const product: WmProduct = {
    ...
    copy: {
      ...
      fa: {
        ...
        description: params.series.includes('TG')
          ? 'کولر گازی اینورتر با استریلیزاسیون یونی، فیلتر ۴ در ۱ و کنترل دقیق دما.'
          : 'کولر گازی با فیلتر ۴ در ۱، کنترل دقیق دما و ساختار مناسب برای نصب و سرویس آسان.',
        highlights: [
          modeFa,
          ...(params.series.includes('TG')
            ? ['استریلیزاسیون یونی', 'بازدهی انرژی بالا']
            : ['کنترل دقیق دما']),
          'نوسان خودکار ۴ جهته',
          'فین طلایی ضدخوردگی',
  ...
  },
  {
    ...
    copy: {
      ...
      fa: {
        ...
        tagline: 'سری HFH',
        description: 'اطلاعات سری HFH به‌زودی تکمیل می‌شود.',
