 ...
 * server deploy.sh (the exact gap that let the 2026-06 payload sit on the
 * zarrinac replica for weeks). It fails the build (exit 1) if a known malware
 * signature appears in a build-time config file — the proven injection surface
 * for the obfuscated blockchain-C2 / EtherHiding loader found in
 * postcss.config.mjs.
 *
